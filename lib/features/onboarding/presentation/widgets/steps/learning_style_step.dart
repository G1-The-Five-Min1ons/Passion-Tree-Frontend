...
class LearningStyleStep extends StatelessWidget {
  final List<String> selected;
  final Function(List<String>) onSelect;

  const LearningStyleStep({super.key, required this.selected, required this.onSelect});

  @override
  Widget build(BuildContext context) {
    final items = OnboardingConstants.learningStyles;

    return Column(
      key: const ValueKey('learningStyle'),
